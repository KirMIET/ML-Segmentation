...
CHECKPOINT_PATHS = [
    # r"./changes/change14/UnetPlusPlus_fold_1/best_UnetPlusPlus_fold_1.pth",
    # r"./changes/change14/UnetPlusPlus_fold_2/best_UnetPlusPlus_fold_2.pth",
    # r"./changes/change14/UnetPlusPlus_fold_3/best_UnetPlusPlus_fold_3.pth",
    # r"./changes/change14/UnetPlusPlus_fold_4/best_UnetPlusPlus_fold_4.pth",
    
    # r"./changes/change14/SegFormer_fold_1/best_SegFormer_fold_1.pth",
    # r"./changes/change14/SegFormer_fold_2/best_SegFormer_fold_2.pth",
    # r"./changes/change14/SegFormer_fold_3/best_SegFormer_fold_3.pth",
    # r"./changes/change14/SegFormer_fold_4/best_SegFormer_fold_4.pth",
    
    # r"./changes/change14/UPerNet_fold_1/best_UPerNet_fold_1.pth",
    # r"./changes/change14/UPerNet_fold_2/best_UPerNet_fold_2.pth",
    # r"./changes/change14/UPerNet_fold_3/best_UPerNet_fold_3.pth",
    # r"./changes/change14/UPerNet_fold_4/best_UPerNet_fold_4.pth",
]
...
CHECKPOINT_PATHS = [
    ...
    # r"./changes/change15/UnetPlusPlus_fold_3/best_UnetPlusPlus_fold_3.pth",
    # r"./changes/change15/UnetPlusPlus_fold_4/best_UnetPlusPlus_fold_4.pth",

    # r"./changes/change15/UPerNet_fold_2/best_UPerNet_fold_2.pth",
    # r"./changes/change15/UPerNet_fold_3/best_UPerNet_fold_3.pth",
    # r"./changes/change15/UPerNet_fold_4/best_UPerNet_fold_4.pth",
    # r"./weights/best_model_fold_3.pth",
    # r"./weights/best_model_fold_4.pth",
]
...
OUTPUT_WEIGHTS_PATH = "submissions/ensemble_weights_best.json"


# =========================
# LOAD WEIGHTS FUNCTION (для использования в inference_ensemble.py)
# =========================
