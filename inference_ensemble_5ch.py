...
# =========================
# CONFIG — ВПИШИТЕ ПУТИ ДО ЧЕКПОИНТОВ ЗДЕСЬ
# =========================
TEST_IMAGES_DIR = Path(r"dataset/best_dataset/test_images")
OUTPUT_CSV = "submissions/submission_ensemble_5ch.csv"

CHECKPOINT_PATHS = [
    # r"./changes/change13/UnetPlusPlus_fold_1/best_UnetPlusPlus_fold_1.pth",
    ...
    r"./changes/change13/UnetPlusPlus_fold_4/best_UnetPlusPlus_fold_4.pth",

    # r"./changes/change13/UPerNet_fold_2/best_UPerNet_fold_2.pth",
    r"./changes/change13/UPerNet_fold_3/best_UPerNet_fold_3.pth",
    r"./changes/change13/UPerNet_fold_4/best_UPerNet_fold_4.pth",
]

ENSEMBLE_WEIGHTS_FILE = r"submissions/ensemble_weights_5ch.json" #r"submissions/ensemble_weights.json"

IMG_EXTS = {".jpg", ".jpeg", ".png", ".bmp", ".tif", ".tiff", ".webp"}
THRESHOLD = 0.41
DEVICE = "cuda" if torch.cuda.is_available() else "cpu"
IN_CHANNELS = 5  # 5-channel input (RGB + XY coordinates)
...
# =========================
# HELPERS (Coordinates, Morphology)
# =========================
...
def prepare_input(image_rgb: np.ndarray, target_size: int) -> torch.Tensor:
    """Подготавливает входной тензор для модели (5-channel: RGB + XY coordinates)."""
