"""
Optimal Threshold Finder for Mixed Ensemble (3ch + 5ch)
========================================================
Запускает inference ансамбля на валидационной выборке,
где модели могут иметь разное число каналов (3 или 5).

Автоматически определяет use_coordinates из конфига чекпоинта,
и находит оптимальный порог по Dice БЕЗ переполнения оперативной памяти.
"""
